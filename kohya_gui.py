...
def initialize_ui_interface(config, headless, use_shell, release_info, readme_content):
    ...
    ui_interface = gr.Blocks(css=css, title=f"SECourses Premium Kohya GUI V40.2", theme=gr.themes.Default())
    with ui_interface:
        gr.Markdown("## SECourses Premium Kohya GUI V40.2: https://www.patreon.com/posts/112099700")
